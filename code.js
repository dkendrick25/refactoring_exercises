...
function tallyGrades(students) {
  ...
  // students.reduce(function(tally, students) {
  //   var grade = students.grade;
  //   if (grade >= 90) {
  //     tally.A++;
  //   } else if (grade >= 80) {
  //     tally.B++;
...
*/
function getHitPoints(player, player2, hitPertcentage) {
  var playerHitPoints = player2.power;
  if (Math.random() > hitPertcentage) {
...
function fight(human, goblin) {
  ...
  goblin.health -= getHitPoints(goblin, human, 0.5);

  // goblin attacks human
  // induce damage to human
  human.health -= getHitPoints(human, goblin, 0.2);
}
// function fight(human, goblin) {
//   // human attacks goblin
